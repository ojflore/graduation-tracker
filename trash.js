...
var catalogIT = [
  ...
  //New Table
  {
    title: 'MBA Core Curriculum:', // <-- table
    courses: [ // <-- rows
      //Next Course starts heare
      {
        title: 'MBA 511',
  ...
  //New Table
  {
    title: 'Business Analytics Track:', // <-- table
    courses: [ // <-- rows
      //Next Course starts heare
      {
        title: 'MBA 542',
  ...
  //New Table
  {
    title: 'Minor Requirements (9 credits)', // <-- table
    courses: [ // <-- rows
      //Next Course starts heare
      {
  ...
  ----------------------------- */
  {
    ...
    courses: [
      {
        title: 'Course One in the second catalog',
        credits: '3.0',
        completed: false,
        prerequisites: [],
        Semester: ["FA"]
      ...
      {
        title: 'Course Two in the second catalog',
        credits: '3.0',
        completed: false,
        prerequisites: [],
        Semester: ["FA"]
